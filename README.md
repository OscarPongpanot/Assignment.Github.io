...
![แสดงหน้าต่าง Design View ของตาราง Employees](Comptia Assign Pic/1.3.7/1..png)
...
![แสดงหน้าต่าง Relationships ที่เห็นตาราง Orders](ใส่ลิงก์รูปภาพของคุณที่นี่)

**คำตอบ:** * `[เติมชื่อตารางที่เชื่อมโยงกับ Orders เช่น Customers, Employees]`
...
**คำตอบ:** * `[เติมชื่อฟิลด์ที่เป็น Foreign Key เช่น ProductTypeID]`
