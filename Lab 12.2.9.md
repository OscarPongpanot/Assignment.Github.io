...
![แสดงการใช้ Filter ค้นหาชื่อสินค้าและดูราคา](ใส่ลิงก์รูปภาพของคุณที่นี่)

**คำตอบ:** * `[ใส่คำตอบที่พบในช่อง UnitPrice เช่น 2.99]`
...
**คำตอบ:** * `[ใส่คำตอบที่พบ เช่น PK-7098]`
...
![แสดงการใช้ Text Filter แบบ Contains](ใส่ลิงก์รูปภาพของคุณที่นี่)

**คำตอบ:** * `[ใส่จำนวนตัวเลขที่นับได้ เช่น 250]`
...
**คำตอบ:** * `[ใส่ชื่อพนักงานที่พบในตาราง]`
...
![แสดงการจัดวาง Field ใน Pivot Table](ใส่ลิงก์รูปภาพของคุณที่นี่)

**คำตอบ:** * `[ใส่ผลรวม OrderQty ของ Product 712]`
...
**คำตอบ:** * `[ใส่จำนวนแถว (observations) ที่นับได้]`
...
![แสดงการพิมพ์สูตร Average, Max, Min](ใส่ลิงก์รูปภาพของคุณที่นี่)

**คำตอบ:** * Mean: `[ใส่ค่าที่คำนวณได้]`
* Highest: `[ใส่ค่าที่คำนวณได้]`
* Lowest: `[ใส่ค่าที่คำนวณได้]`
...
**คำตอบ:** * `[ใส่ชื่อสินค้าที่อยู่บนสุด]`
...
**โจทย์:** 5. Which month has the highest quantities ordered over the full two year period? / 6. Which month in 2012 had the lowest quantity ordered?
...
![แสดงกราฟ Pivot Chart ข้อมูลรายเดือน](ใส่ลิงก์รูปภาพของคุณที่นี่)

**คำตอบ:** * 5. Highest month: `[เลือกจากตัวเลือก เช่น Jul]`
* 6. Lowest month 2012: `[เลือกจากตัวเลือก เช่น Feb]`
...
**คำตอบ:** * 7. Greatest % change: `[เลือกเดือนที่พบ]`
* 8. Months with no increase: `[เลือกเดือนที่พบ เช่น Jan]`
...
5. ดูค่าตัวเลขในบรรทัดที่เขียนว่า **Median** และ **Mode** ![แสดงหน้าต่างผลลัพธ์ Descriptive Statistics](ใส่ลิงก์รูปภาพของคุณที่นี่)

**คำตอบ:** * Median: `[ใส่ตัวเลขที่พบ เช่น $XXX]`
* Mode: `[ใส่ตัวเลขที่พบ เช่น $XXX]`
